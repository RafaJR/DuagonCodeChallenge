...
public class ApplicationStartUp implements ApplicationListener<ApplicationReadyEvent> {
	...
	public void onApplicationEvent(ApplicationReadyEvent event) {
		...
		// Saving brands
		Brands brand1 = brandsDao.save(Brands.builder()
				.brandName("ZARA")
				.brandDescription("Textile products supplier")
				.build());
		Brands brand2 = brandsDao.save(Brands.builder()
				.brandName("IKEA")
				.brandDescription("Forniture supplier")
				.build());
		
		// Saving rates
		Rates rate1 = ratesDao.save(Rates.builder()
				.rateCode("1")
				.build());
		Rates rate2 = ratesDao.save(Rates.builder()
				.rateCode("2")
				.build());
		Rates rate3 = ratesDao.save(Rates.builder()
				.rateCode("3")
				.build());
		Rates rate4 = ratesDao.save(Rates.builder()
				.rateCode("4")
				.build());
		
		// Saving products		
		Products product1 = productsDao.save(Products.builder()
				.productCodeId("35455")
				.productName("Gentleman suit")
				.build());
		Products product2 = productsDao.save(Products.builder()
				.productCodeId("19347")
				.productName("Necktie")
				.build());
		
		// Saving Currencies
		Currencies currency1 = currencyDao.save(Currencies.builder()
				.currencyISO("EUR")
				.build());
		Currencies currency2 = currencyDao.save(Currencies.builder()
				.currencyISO("USD")
				.build());
		
		// Saving prices
		if(Stream.of(
				pricesDao.savePrice(Prices.builder()
				.fkProductId(product1)
				.fkBrandId(brand1)
				.fkCurrencyId(currency1)
				.fkRatesId(rate1)
				.price(35.50d)
				.priority(0)
				...
				pricesDao.savePrice(Prices.builder()
						...
						.build()),
				pricesDao.savePrice(Prices.builder()
						.fkProductId(product2)
						.fkBrandId(brand2)
						.fkCurrencyId(currency2)
						.fkRatesId(rate4)
						.price(20.50d)
						.priority(0)
